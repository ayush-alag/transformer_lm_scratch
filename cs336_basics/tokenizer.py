...
class BPETokenizer:
   ...
   def merge_tokens(self,
      ...
      for _ in range(num_merges):
         ...
         self.merge_pair(best_pair, pretokenized_bytes_to_count, unique_token_list, pair_to_locs, pair_to_count)
   ...
   def train_bpe(self) -> \
      tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
         pretokenized_bytes_to_count, pretoken_list, pair_to_locs, pair_to_count = self.pretokenize_input()
